...
export class Results implements OnInit, AfterViewInit {
  ...
  exportAsPdf(): void {
    ...
    if (report.scoreBreakdown) {
      ...
      line(`Rule-Based: ${report.scoreBreakdown.ruleScore}/100  |  AI: ${report.scoreBreakdown.aiScore}/100  |  Final: ${report.scoreBreakdown.finalScore}/100`, 10, false, [200, 200, 200]);
      if (report.scoreBreakdown.criticalOverride) line('! Critical override applied', 9, false, [255, 59, 59]);
      y += 4;
    }
