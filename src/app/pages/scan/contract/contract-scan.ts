...
@Component({
  selector: 'app-contract-scan',
  standalone: true,
  imports: [RouterLink, NotificationsComponent],
  templateUrl: './contract-scan.html',
  styleUrl: './contract-scan.scss',
})
export class ContractScan implements OnInit {
  ...
  readonly supportedFormats = ['PDF', 'DOCX', 'DOC', 'TXT'];
  ...
  async startScan(): Promise<void> {
    ...
    try {
      ...
      const scanId = await this.scanService.scanFile(file, 'contract');
