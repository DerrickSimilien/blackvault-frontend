...
@Component({
  ...
  templateUrl: './resume-scan.html',
  styleUrl: './resume-scan.scss',
})
export class ResumeScan implements OnInit {
  ...
  readonly acceptedExtensions = ['.pdf', '.docx', '.doc', '.txt', '.rtf'];

  readonly supportedFormats = ['PDF', 'DOCX', 'DOC', 'TXT', 'RTF'];
  ...
  async startScan(): Promise<void> {
    ...
    try {
      ...
      const scanId = await this.scanService.scanFile(file, 'resume');
